      ...
      <div className="gauche">
        ...
        <div className="bouton_pied_page">
          ...
          <div className="button-row2">
            <button
              onClick={() => window.open("./basketball/spectators", "_blank")}
            >
              Spectateurs
            </button>
          </div>
        ...
        <div className="scoreboard">
          <div className="score-display mb-6 text-xl">
            ...
            <div className="info-line">
              <p>
                {matchType !== "Type de match" ? matchType : "Type de match"} -
                {
                  // Affiche toujours le nom du terrain si possible
                  courts.find((c) => c.id === matchData.court?.toString())
                    ?.name ||
          ...
          <div className="controls-section flex flex-col gap-4">
            ...
            <div className="timers mb-6 text-2xl">
              <div className="timer" id="gameTimer">
                {formattedTime}
              </div>
              {shouldShowShotClock && (
                <div
                  className="timer"
                  id="shotClock"
                  style={pauseShotClock ? { opacity: 0.5 } : {}}
                >
                  {formattedShotClock}
                </div>
              )}
            ...
            <div className="flex justify-center gap-4 mb-6 text-lg">
              <section>
                <div className="scores">
                  <p>Fautes : {matchData.teamA.fouls || 0}</p>
                  <div className="team-controls a">
                    <button onClick={() => subFault("A", 1)}>
                      -1<span className="shortcut-hint">Q</span>
                    </button>
                    <button onClick={() => addFault("A", 1)}>
              ...
              <section>
                <div className="scores">
                  <p> Fautes : {matchData.teamB.fouls || 0}</p>
                  <div className="team-controls b">
                    <button onClick={() => subFault("B", 1)}>
                      -1<span className="shortcut-hint">L</span>
                    </button>
                    <button onClick={() => addFault("B", 1)}>
            ...
            >
              ...
              <button
                ...
                style={possession ? { background: "#e53935", color: "white" } : {}}
              >
