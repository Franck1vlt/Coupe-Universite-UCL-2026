...
export interface MatchData {
  ...
  currentThrows?: number[];     // Les fléchettes de la volée en cours (max 3) — valeurs après multiplicateur
  currentThrowsBases?: number[]; // Valeurs de base avant multiplicateur (pour idempotence de multiplyLastThrow)
