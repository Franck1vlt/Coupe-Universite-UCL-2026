      ...
      <section className="score-board-container gap-8">
        ...
        <div className="flex items-center justify-between w-full gap-4 md:gap-12">
          ...
          <div className="team-column">
            <div className="logo-wrapper">
              <Image
                ...
                height={180}
                className="team-logo"
                onError={() => setLogoB("/img/no-logo.png")}
                priority
              />
            </div>
          ...
          <div className="score-display">
            <span className={animateScoreB ? "score-change" : ""}>
              {matchData.score2 || 0}
            </span>
            <span className="mx-2 md:mx-4">-</span>
            <span className={animateScoreA ? "score-change" : ""}>
              {matchData.score1 || 0}
            </span>
          </div>
          ...
          <div className="team-column">
            <div className="logo-wrapper">
              <Image
                ...
                height={180}
                className="team-logo"
                onError={() => setLogoA("/img/no-logo.png")}
                priority
              />
            </div>
        ...
        <div className="cards-row">
          <div className="card-group">
            ...
            <span className="card-icon ml-2">🟥</span>{" "}
            {matchData.redCards2 || 0}
          </div>
          <div className="card-group">
            <span className="card-icon">🟨</span> {matchData.yellowCards1 || 0}
            <span className="card-icon ml-2">🟥</span>{" "}
            {matchData.redCards1 || 0}
          </div>
        </div>
          ...
          <div className="goal-animation-overlay animate-goal-in">
            ...
            {goalAnimation.playerNumber != null && (
              <div className="text-3xl font-bold text-white mb-1">
                N°{goalAnimation.playerNumber} —{" "}
                {goalAnimation.playerName || "Anonyme"}
              </div>
            )}
