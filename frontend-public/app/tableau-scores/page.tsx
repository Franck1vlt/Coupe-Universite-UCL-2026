...
export default function TableauScoresPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-100 flex flex-col items-center justify-center px-2 sm:px-4 py-6 sm:py-8">
      {/* Bouton retour */}
      <button
        onClick={() => router.push("/")}
      ...
      <section className="w-full px-1 sm:px-2 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-lg border-2 border-transparent p-1 sm:p-3 md:p-6 overflow-x-auto">
          {/* Filtre par tournoi */}
          <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3">
            <label className="text-xs sm:text-sm font-medium text-gray-700">Filtrer par tournoi :</label>
            <select
              ...
              className="px-2 sm:px-4 py-2 text-black border border-gray-300 rounded-lg text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[500px] sm:min-w-[650px] text-xs sm:text-sm md:text-base">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  <th className="px-2 sm:px-4 py-2 sm:py-4 text-left text-base sm:text-lg font-semibold text-gray-800 whitespace-nowrap">
                    Position
                  </th>
                  <th className="px-2 sm:px-4 py-2 sm:py-4 text-left text-base sm:text-lg font-semibold text-gray-800 whitespace-nowrap">
                    Équipe
                  </th>
                  <th className="px-2 sm:px-4 py-2 sm:py-4 text-center text-base sm:text-lg font-semibold text-gray-800 whitespace-nowrap">
                    Points
                  </th>
                  <th className="px-2 sm:px-4 py-2 sm:py-4 text-center text-xs font-semibold text-gray-800 whitespace-nowrap">
                    Matchs
                  </th>
                  <th className="px-2 sm:px-4 py-2 sm:py-4 text-center text-xs font-semibold text-gray-800 whitespace-nowrap">
                    V
                  ...
                  >
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-4">
                      <div className="flex items-center">
                        <span className={`inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold ${getPositionBadgeColor(item.position)}`}>
                      ...
                      <div className="flex items-center min-w-0">
                        <div className="flex-shrink-0 h-8 w-8 sm:h-12 sm:w-12">
                          {item.team.logo_url ? (
                            ...
                            <div 
                              className="h-8 w-8 sm:h-12 sm:w-12 rounded-full flex items-center justify-center text-white font-bold text-base sm:text-lg"
                    ...
                    {selectedTournamentId === null && (
                      <>
                        ...
                        <td className="px-2 sm:px-4 py-2 sm:py-4 text-center">
                          <div className="text-xs sm:text-sm font-semibold text-amber-600">
